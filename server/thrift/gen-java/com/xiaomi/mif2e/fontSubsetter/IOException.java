...
public class IOException extends TException implements
		org.apache.thrift.TBase<IOException, IOException._Fields>,
		java.io.Serializable, Cloneable, Comparable<IOException> {
	...
	static {
		schemes.put(StandardScheme.class,
				new IOExceptionStandardSchemeFactory());
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		 ...
		 * @see ExceptionType
		 */
		TYPE((short) 1, "type"), WHY((short) 2, "why");
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				IOException.class, metaDataMap);
	}

	public IOException() {
	}

	public IOException(ExceptionType type, String why) {
		this();
		this.type = type;
		this.why = why;
	}
	 ...
	 * @see ExceptionType
	 */
	public IOException setType(ExceptionType type) {
		this.type = type;
		return this;
	}
	...
	public IOException setWhy(String why) {
		this.why = why;
		return this;
	}
	...
	private static class IOExceptionStandardSchemeFactory implements
			SchemeFactory {
	...
	private static class IOExceptionStandardScheme extends
			StandardScheme<IOException> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				IOException struct) throws org.apache.thrift.TException {
	...
	private static class IOExceptionTupleScheme extends
			TupleScheme<IOException> {
